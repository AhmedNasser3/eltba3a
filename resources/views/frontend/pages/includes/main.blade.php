        ...
        <div class="main_data">
            ...
            <div class="main_content">
                <div class="main_title">
                    ...
                    <h4>
                        المرشد نت شركة رائدة في تصميم المواقع وتطوير تطبيقات الجوال بخبرة تتجاوز 12 عامًا، تقدم حلولًا
                        مبتكرة، حماية مضمونة، وتسويق رقمي شامل بما في ذلك إدارة حسابات التواصل الاجتماعي.
                    </h4>
                </div>
                <div class="main_btns">
            ...
            <div class="partners_data">
                ...
                <div class="partners_boxes">
                    <div class="partners_slider">
                        <div class="partners_boxes_img"><img src="{{ asset('الشعار.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/1.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/22.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/3.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/4.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/5.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/6.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/1.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/22.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/3.png') }}" alt=""></div>
                        <div class="partners_boxes_img"><img src="{{ asset('images/4.png') }}" alt=""></div>
                    ...
                    <div class="option_box_container">
                        <div class="option_box_content">
                            <div class="option_box_data">
                                ...
                                <div class="option_box_1_cn">
                                    <div class="option_box_1_bg"
                                        style="    border: 2px solid #4fccb7;background-color: #4fccb7;">
                                        <div class="option_box__1_text">
                                            <h4>اسود</h4>
                                        </div>
                                    </div>
                                ...
                                <div class="option_box_1_title"
                                    style="padding: 2% 0 0 0;display:flex;justify-content:center">
                                    <h3>معلومات حول الطلب </h3>
                                </div>
                                <div class="option_box_1_cn" style="display:flex;justify-content:center">
                                    <textarea name="" id="" style="height: 100px;width:1000px"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
